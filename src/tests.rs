...
fn arith() {
    ...
    let x1 = BigBounded::from_hex("10498385709182435134");
    let x2 = BigBounded::from_hex("9871425437538592414723");
    let x3 = x1 + x2;
    assert_eq!(BigBounded::from_hex("98818bd7bcc41714849857"), x3.into());
